...
const TabsTrigger = React.forwardRef<
  HTMLButtonElement,
  React.ButtonHTMLAttributes<HTMLButtonElement> & { value: string; activeValue?: string; onTabChange?: (value: string) => void }
>(({ className, value, activeValue, onTabChange, ...props }, ref) => {
